...
public class ProductController {
    ...
    public ResponseEntity<Product> create(@RequestBody ProductCreateRequest request) {
        Product response = productUseCase.create(new ProductUseCase.CreateProductCommand(
                request.sellerId(),
                request.name(),
                request.description(),
                request.price(),
    ...
    public Product update(@Parameter(description = "상품 UUID") @PathVariable UUID productId,
        ...
        return productUseCase.update(productId, new ProductUseCase.UpdateProductCommand(
                request.name(),
                request.description(),
                request.price(),
                request.stock(),
